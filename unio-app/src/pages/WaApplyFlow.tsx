...
function buildScript(answers: Answers): Record<StepId, StepDef> {
  ...
  return {
    ...
    qm_experiencia: {
      botMessages: [
        '¡Excelente! ✅ ¿Tienes *disponibilidad completa para turnos rotativos* de lunes a domingo?',
      ],
      replies: [
        { id: 'si', label: '✅ Sí, disponibilidad total', value: 'si' },
        { id: 'no', label: '❌ Tengo restricciones',      value: 'no' },
      ],
    ...
    qm_ubicacion: {
      botMessages: [
        '¿Vives en *Medellín o el área metropolitana*? 📍',
      ],
      replies: [
        { id: 'si', label: '✅ Sí, resido en el área',   value: 'si' },
        { id: 'no', label: '❌ Resido en otra ciudad',   value: 'no' },
      ],
    ...
    cvb_ciudad: {
      ...
      inputPlaceholder: 'Ej: Medellín, Bello, Envigado…',
      next: () => 'cvb_exp_anos',
    },
    ...
    cvb_exp_anos: {
      ...
      replies: [
        ...
        { id: 'a3', label: '1–3 años',           value: '1_3' },
        { id: 'a4', label: 'Más de 3 años',      value: 'mas_3' },
      ],
    ...
    ps_no_neg_1: {
      botMessages: [
        ...
        '¿Tienes *mínimo 6 meses de experiencia certificada en servicio al cliente* (con NIT, certificable)?',
      ],
      replies: [
        { id: 'si', label: '✅ Sí, tengo la experiencia',   value: 'si' },
        { id: 'no', label: '❌ No cumplo este requisito',   value: 'no' },
    ...
    ps_no_neg_2: {
      botMessages: ['¿Tienes *disponibilidad completa para turnos rotativos* de lunes a domingo?'],
      replies: [
        { id: 'si', label: '✅ Sí, disponibilidad total',   value: 'si' },
        { id: 'no', label: '❌ Tengo restricciones',        value: 'no' },
      ],
    ...
    ps_no_neg_3: {
      botMessages: [
        '¿Resides en *Medellín o área metropolitana*?',
      ],
      replies: [
        { id: 'si', label: '✅ Sí, resido en el área',      value: 'si' },
        { id: 'no', label: '❌ Resido en otra ciudad',      value: 'no' },
    ...
    ps_entrevista: {
      botMessages: [
        ...
        '¿Estarías disponible para una *entrevista presencial* durante los próximos 5 días hábiles?',
      ],
      replies: [
