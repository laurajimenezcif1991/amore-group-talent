...
const TIPS = [
  ...
  { label: 'Página web', text: 'Refuerza el employer branding con candidatos que ya conocen Demo Restaurantes.' },
...
export default function CanalesPublicacion() {
  ...
  const [channels, setChannels] = useState<Channel[]>([
    ...
    },
    {
      ...
      description: 'Sección "Trabaja con nosotros" en el sitio corporativo demorestaurantes.com.co. Requiere integración previa.',
      checked: false,
    },
    {
      id: 'qr',
    ...
    <div style={{ minHeight: '100vh', background: 'var(--color-surface-subtle)', fontFamily: 'var(--font-display)' }}>
      ...
      <header style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
          <img src={assetUrl('/logo-demo-restaurantes.png')} alt="Demo Restaurantes"
