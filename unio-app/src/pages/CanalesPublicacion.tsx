...
const TIPS = [
  ...
  { label: 'Página web', text: 'Refuerza el employer branding con candidatos que ya conocen Amore Group Talent.' },
    ...
    <div style={{ minHeight: '100vh', background: 'var(--color-surface-subtle)', fontFamily: 'var(--font-display)' }}>
      ...
      <header style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
          <img src={assetUrl('/logo-amore-group.png')} alt="Amore Group Talent"
