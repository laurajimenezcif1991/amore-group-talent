...
const GUIDE_QUESTIONS: Record<InterviewerRole, { label: string; q: string }[]> = {
  ...
  jefe: [
    { label: 'Experiencia técnica',  q: '¿Qué tan detallado fue al describir su experiencia en cocina o servicio al cliente?' },
    { label: 'Gestión operativa',    q: '¿Cómo explicó su manejo de estaciones de trabajo, higiene y tiempos de servicio?' },
    { label: 'Contingencias',        q: '¿Cómo respondió ante situaciones de alta demanda, picos de servicio o imprevistos en cocina?' },
    { label: 'Trabajo en equipo',    q: '¿Demostró habilidad para coordinarse con compañeros de barra, cocina y sala?' },
    { label: 'Disponibilidad',       q: '¿Mostró disposición para turnos rotativos, fines de semana y festivos?' },
    { label: 'Normas de higiene',    q: '¿Describió una actitud positiva hacia los protocolos de higiene y manipulación de alimentos?' },
    { label: 'Atención al cliente',  q: '¿Demostró capacidad para relacionarse con clientes y resolver quejas o solicitudes?' },
  ],
};
