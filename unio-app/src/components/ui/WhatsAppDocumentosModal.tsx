  ...
  return [
    ...
    },
    {
      ...
      text: `🪪 *Documentos de Identidad*\n\n` +
        ...
        `6️⃣ *Certificado de manipulación de alimentos* – Vigente y expedido por entidad autorizada\n` +
        `7️⃣ *Certificado de estudios* – Diploma o acta de grado del último nivel alcanzado`,
    },
    {
