...
function buildConversation(firstName: string, jobTitle: string, aspiration: string): WaMsg[] {
  ...
  return [
    ...
    // 14-16 Cierre
    { from: 'candidate', time: fmt(14), text: aspiration || "$1'705.905 con los beneficios del cargo." },
    { from: 'alex',      time: fmt(15), text: `¡Perfecto, ${firstName}! 🙌 Sus datos están muy bien. El equipo de selección revisará su perfil y le contactará para los próximos pasos. ¿Tiene alguna duda?` },
