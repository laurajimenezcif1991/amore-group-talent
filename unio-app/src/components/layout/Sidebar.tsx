...
export default function Sidebar({ activeItem }: SidebarProps) {
  ...
  const PIPELINE_STAGES = ['scoring', 'prescreening', 'entrevistas', 'evaluaciones', 'prueba_conocimiento'] as const;
  ...
  const getActiveId = (): string => {
    ...
    if (path.includes('/candidate/') || path.includes('/finalist/')) {
      ...
      if (stage && ['scoring', 'prescreening', 'entrevistas', 'evaluaciones', 'prueba_conocimiento', 'estudios', 'finalistas'].includes(stage)) return stage;
